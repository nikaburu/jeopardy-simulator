			...
			return new QuestionGroup(_random.Next(int.MaxValue), new List<Question>
			{
				new Question
				{
					...
					Text =
						"Что такое экономика?",
					Answer =
						"Совокупность общественных наук, изучающих производство, распределение и потребление товаров и услуг. Экономическая действительность является объектом экономических наук, которые подразделяется на теоретические и прикладные.",
					Cost = 10*multi,
					TextImage = image
				},
				new Question
				{
					...
					Answer =
						"Ещё в IV веке до н. э. Ксенофонт написал произведение под названием «Домострой» , переведённое Цицероном на латынь как лат. Oeconomicus",
					Cost = 20*multi,
					TextImage = image,
					AnswerImage = image
				},
				new Question
				{
					...
					Answer =
						"Всеобщее признание термин получил после того как был употреблен в заглавии труда Джона Стюарта Милля «Основы политическаой экономии»",
					Cost = 30*multi,
					AnswerImage = image
				},
				new Question
				{
					...
					Answer =
						"с выходом в свет книги Адама Смита «Исследование о природе и причинах богатства народов» (распространённое название «Богатство народов») в 1776 году",
					Cost = 50*multi
				},
				new Question
				{
